    ...
    handleInput: function handleInput(event) {
        ...
        this.setState({
            ...
            if (isModernBrowser) {
                ...
                if (caretPosition > 0 && /(android)/i.test(navigator.userAgent)) {
                     setTimeout(function(){this.refs.numberInput.setSelectionRange(formattedNumber.length, formattedNumber.length);}, 10);
                }
